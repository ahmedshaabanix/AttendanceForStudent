"""
Django settings for scanx project.
...
SECRET_KEY = '^m$uuyl7v9_kx^=(5+pcobsk$a4g6i6p-2%-54whi3r_p4%+!='
...
WSGI_APPLICATION = 'scanx.wsgi.application'
...
EMAIL_PORT = '587'
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'add google account'
